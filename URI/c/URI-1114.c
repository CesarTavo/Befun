 ...
 *
 * Input
 * The input file contains several tests cases. 
 * Each test case contains only an integer number.
 *
 * Output
 * For each number read print a message 
 * corresponding to the description of the problem.
 */
